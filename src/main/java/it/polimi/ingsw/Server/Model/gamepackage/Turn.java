...
import it.polimi.ingsw.server.model.gamepackage.actions.*;
import it.polimi.ingsw.server.model.gamepackage.turnstates.*;
import it.polimi.ingsw.server.model.gamestates.LastRound;
...
public class Turn {
    ...
    */
    public void setNextState(AbstractTurnState nextState, Action action) {
        ...
        if(currentState instanceof End)
            game.nextTurn();
    }
