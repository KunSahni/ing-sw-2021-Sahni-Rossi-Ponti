...
/**
 * This class is used by the ClientSocket to warn the UI about the server being offline
 */
public class ServerOfflineUpdate extends BroadcastRenderable {
    /**
